...
*Defined in [assertions/assertNodeIsHtmlAudio.ts:8](https://github.com/furkleindustries/sound-manager/blob/5232f22/src/assertions/assertNodeIsHtmlAudio.ts#L8)*
